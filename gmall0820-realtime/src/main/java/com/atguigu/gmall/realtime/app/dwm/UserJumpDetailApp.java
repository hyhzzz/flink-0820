...
//        env.setStreamTimeCharacteristic(TimeCharacteristic.EventTime);
        ...
        /*
                计算页面跳出明细，需要满足两个条件
                    ...
                    2.距离首次访问接胡搜后10秒内，没有对其他的页面在进行访问
         */
        //TODO 6.配置CEP表达式
...
//        );
        ...
        //区别在于select往下输出是通过返回值的方式只能返回一个值
        //       flatSelect往下输出的时候是通过集合的方式 可以返回多个值
