...
//        env.setStateBackend(new FsStateBackend("hdfs://hadoop102:8020/gmall/flink/checkpoint/paymentWide"));
...
//        orderWideDS.print("orderWide>>");
        ...
        //TODO 4.设置watermark 以及 提取事件时间字段
        //4.1 支付流watermark
        ...
        paymentWideDS.map(paymentWide -> JSON.toJSONString(paymentWide)).addSink(
